...
CREATE TABLE IF NOT EXISTS IDN_OAUTH_CONSUMER_APPS (
            ...
            NEW_COLUMN_ADDITIVE VARCHAR(100),
...
CREATE INDEX IDX_NEW_ADDITIVE ON IDN_OAUTH2_ACCESS_TOKEN(TOKEN_STATE, USER_TYPE);
...
CREATE TABLE TEST_ADDITIVE ( ID INT, NAME VARCHAR(50) );
